...
Be part of the [development team](/about#current-members) working on ALT Tutors website. 
...
<Callout>
This is essential for the Team Leader to invite you to the GitHub repository and Jira.
</Callout>

### Wait for invite

While waiting, you can start reading the [fundamentals](/getting-started/primer) and familiarize yourself with the tech stack.
