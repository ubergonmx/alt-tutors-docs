...
- Use interfaces when you want to define the shape of an object.
- Use types when you want to define the types of variables, parameters, and return values in a function.
- Use interfaces when you want to extend an existing interface.
- Use types when you want to create an alias for a union type or a tuple type.
