...
# A Comprehensive Guide on Naming Variables and Functions

<Callout type="info">
  The content below has been adapted from the [guide by
  kettanaito](https://github.com/kettanaito/naming-cheatsheet). Please note that ALT Tutors team
  does not own this content, and all credit goes to the original creator.
</Callout>
