...
const config: DocsThemeConfig = {
  head: () => {
    ...
    const url =
      'https://alt-tutors-docs.vercel.app' +
    ...
    return (
      <>
        ...
        <meta name="apple-mobile-web-app-title" content="ALT Tutors Docs" />
  ...
  useNextSeoProps() {
    ...
    if (asPath !== '/') {
      return {
        titleTemplate: '%s – ALT Tutors Docs',
      }
    }
    return {
      titleTemplate: 'ALT Tutors Docs',
    }
  },
  project: {
      ...
      <div className="nx-flex nx-w-full nx-flex-col nx-items-center sm:nx-items-start">
        <div>
          ...
          >
            ...
            <span className="nx-px-1">and</span>
        ...
        <p className="nx-mt-6 nx-text-xs">© {new Date().getFullYear()} ALT Tutors Docs</p>
      </div>
    ),
  },
  feedback: {
